...
function isInsideCircle(circle, point) {
  // throw new Error('Not implemented');
  return point.x > (circle.center.x - circle.radius) && point.y > (circle.center.y - circle.radius)
  && point.x < (circle.center.x + circle.radius) && point.y < (circle.center.y + circle.radius);
}
...
function getDigitalRoot(num) {
  // throw new Error('Not implemented');
  const sum = num.toString().split('').reduce((a, b) => Number(a) + Number(b));
